...
<html>
    <head>
        ...
        <meta charset="UTF-8" />
        <link rel="stylesheet" type="text/css" href="css/screen.css" /> <!--CSS Global site -->
        <link rel="stylesheet" type="text/css" href="css/font-awesome.css" /> <!--CSS icone -->
	<script type="text/javascript" charset="utf8" src="js/jquery-1.12.3.min"></script> 
        <link rel="stylesheet" type="text/css" href="lib/DataTables/datatables.css"> <!--CSS Tableau -->
        <script type="text/javascript" charset="utf8" src="lib/DataTables/datatables.js"></script> <!-- JS Tableau -->
        
        <!-- 
            Pour créer le tableau avec pagination, moteur de recherche, filtrage. 
            Le tableau doit s'appeller table_pagination   
        -->
        <script>
