 ...
 *
 * @package 	default
 * @author 	Baptiste et Alicia ,28/09/2016 , Vincent K.
 * @version    	1.0
 */
/*
 *  ====================================================================
...
class Prets {
     ...
     * @param   $etat : 0 == prêts en cours, 1 == prêts en retard, 2 == prêts terminés normalement, 3 == prêts irrécupérables
     * @return  un tableau de type $mode 
     */    
    public static function chargerLesPrets($mode, $etat = null) {
        ...
        switch ($etat) {
            ...
            case '1' : {
                $tab = PretDal::loadGenericPret(0, array(PRETS_RENDUS_EN_RETARD));
            } break;
            case '2' : {
                $tab = PretDal::loadGenericPret(0, array(PRETS_RENDUS_A_TEMPS));
            } break;
            case '3' : {
                $tab = PretDal::loadGenericPret(0, array(PRETS_EN_RETARD));
            } break;
            default : {
                $tab = PretDal::loadGenericPret(0);
            }
        }
